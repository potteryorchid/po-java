...
//    ImageUtil.zoomInOrOutByRatio("/Users/zj/Documents/bak/test/00.jpg",
...
//    // 方法一：
//    ImageUtil
//        .pressText("我是水印文字", "e:/abc.jpg", "e:/abc_pressText.jpg", "宋体", Font.BOLD, Color.white, 80,
//            0, 0, 0.5f);//测试OK
//    // 方法二：
//    ImageUtil
//        .pressText2("我也是水印文字", "e:/abc.jpg", "e:/abc_pressText2.jpg", "黑体", 36, Color.white, 80, 0,
//            0, 0.5f);//测试OK
//
//    // 6-给图片添加图片水印：
//    ImageUtil.pressImage("e:/abc2.jpg", "e:/abc.jpg", "e:/abc_pressImage.jpg", 0, 0, 0.5f);//测试OK
   ...
   */
  public final static void scale2(String srcImageFile, String result, int height, int width,
      boolean bb) {
    try {
